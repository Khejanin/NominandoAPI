...
module.exports = function(app) {
    ...
    app.route('/text').post(tokenAuthenticator.authenticate,gameController.uploadText).get(tokenAuthenticator.authenticate,gameController.getText);
    app.route('/updateProgress').post(tokenAuthenticator.authenticate,gameController.updateProgress);
